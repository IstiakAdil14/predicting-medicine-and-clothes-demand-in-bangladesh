#!/usr/bin/env python3
"""
Train & evaluate a Regularized RandomForest model to predict district-level clothes demand
...
# 4. Lag features: previous year clothes demand per district and area
...
# --- Plot per district per clothes item with metrics ---
for item in targets:
